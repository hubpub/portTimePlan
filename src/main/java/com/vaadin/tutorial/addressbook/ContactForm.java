...
public class ContactForm extends FormLayout {
    ...
    private void addEditPannel() {
        ...
        HorizontalLayout fullname = new HorizontalLayout(firstName, lastName);
        fullname.setSpacing(true);
        
        addComponents(actions, fullname, phone, email, birthDate);
    }
    ...
    public void save(Button.ClickEvent event) {
        try {
            ...
            // Save DAO to backend with direct synchronous contactCollectionService API
            getUI().contactCollectionService.save(contact);
